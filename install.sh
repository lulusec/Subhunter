...
install_apt_tool "httprobe" # NOVÉ: Pridaná inštalácia httprobe
install_apt_tool "jq"
...
# --- Inštalácia Go (potrebné pre gau, amass, waybackurls, jsubfinder) ---
...
# --- Inštalácia ďalších Go nástrojov ---
install_go_tool "gau" "github.com/lc/gau/v2/cmd/gau@latest"
install_go_tool "waybackurls" "github.com/tomnomnom/waybackurls@latest"
install_go_tool "jsubfinder" "github.com/ThreatUnkown/jsubfinder@latest" # NOVÉ: Pridaná inštalácia jsubfinder
